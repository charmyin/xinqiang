package com.charmyin.cmstudio.web.utils.pagination.proxy;

import org.apache.ibatis.binding.BindingException;
import org.apache.ibatis.binding.MapperMethod;
import org.apache.ibatis.session.SqlSession;
import com.charmyin.cmstudio.web.utils.pagination.uitls.Reflections;
...
public class PaginationMapperProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
        ...
        // 原处理方式
        final PaginationMapperMethod mapperMethod = new PaginationMapperMethod(declaringInterface, method, sqlSession);
